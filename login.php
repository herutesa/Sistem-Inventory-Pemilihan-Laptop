...
if (isset($_POST['proses'])) {
	...
	if ($jum > 0) {
		$hasil = $row->fetch();
		$_SESSION['admin'] = $hasil; // Anda bisa simpan $_SESSION['admin'] sesuai kolom yang dibutuhkan
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
						...
						<div class="p-5">
							...
							<img class="img-profile rounded-circle" src="assets/img/logo.png " alt="" height="250" width="250"> 
							</div><br>
